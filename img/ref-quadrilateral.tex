...
\draw[black,line width=3pt,line cap=round](209.0,15.0) -- (209.0,115.0);
\draw[black,line width=3pt,line cap=round](109.0,115.0) -- (209.0,115.0);
...
\draw[black,line width=3pt,line cap=round](339.0,15.0) -- (339.0,115.0);
\draw[black,line width=3pt,line cap=round](239.0,115.0) -- (339.0,115.0);
...
\draw[black,line width=3pt,line cap=round](469.0,15.0) -- (469.0,115.0);
\draw[black,line width=3pt,line cap=round](369.0,115.0) -- (469.0,115.0);
...
\draw[color1,fill=white,line width=1.5pt] (209.0,115.0)circle (6pt);
\node[anchor=center] at (209.0,115.0) {\small\color{color1}3};
...
\draw[color2,fill=white,line width=1.5pt] (339.0,65.0)circle (6pt);
\node[anchor=center] at (339.0,65.0) {\small\color{color2}2};
\draw[color2,fill=white,line width=1.5pt] (289.0,115.0)circle (6pt);
\node[anchor=center] at (289.0,115.0) {\small\color{color2}3};
